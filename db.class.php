<?php
  ...
  class DB
  {
    ...
    function __construct($base, $server, $user, $pass)
    {
      ...
      mysql_connect($server, $user, $pass) or die('Server connexion not possible. ' . mysql_error());
      mysql_select_db($base)               or die('Database connexion not possible. ' . mysql_error());
    }
